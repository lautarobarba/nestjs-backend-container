...
export class CreateGroupEntity1688172133274 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        if (dbType === "mysql") {
            await queryRunner.query("CREATE TABLE `groups` (`id` int NOT NULL AUTO_INCREMENT, `name` varchar(255) NOT NULL, PRIMARY KEY (`id`), UNIQUE KEY `UQ_664ea405ae2a10c264d582ee563` (`name`))");
            await queryRunner.query("CREATE TABLE `groups_users` (`group_id` int NOT NULL, `user_id` int NOT NULL, PRIMARY KEY (`group_id`, `user_id`))");
            await queryRunner.query("CREATE INDEX `IDX_d8a1834cee7d6347016e3e55f0` ON `groups_users` (`group_id`)");
            await queryRunner.query("CREATE INDEX `IDX_7fff02b7fb30cd3730d90693de` ON `groups_users` (`user_id`)");
            await queryRunner.query("ALTER TABLE `groups_users` ADD CONSTRAINT `FK_d8a1834cee7d6347016e3e55f04` FOREIGN KEY (`group_id`) REFERENCES `groups`(`id`) ON DELETE RESTRICT ON UPDATE CASCADE");
            await queryRunner.query("ALTER TABLE `groups_users` ADD CONSTRAINT `FK_7fff02b7fb30cd3730d90693dec` FOREIGN KEY (`user_id`) REFERENCES `users`(`id`) ON DELETE RESTRICT ON UPDATE CASCADE");
        ...
        throw new Error(`Unsupported DB engine for migration CreateGroupEntity1688172133274: ${dbType}`);
    }
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        if (dbType === "mysql") {
            await queryRunner.query("ALTER TABLE `groups_users` DROP FOREIGN KEY `FK_7fff02b7fb30cd3730d90693dec`");
            await queryRunner.query("ALTER TABLE `groups_users` DROP FOREIGN KEY `FK_d8a1834cee7d6347016e3e55f04`");
            await queryRunner.query("DROP INDEX `IDX_7fff02b7fb30cd3730d90693de` ON `groups_users`");
            await queryRunner.query("DROP INDEX `IDX_d8a1834cee7d6347016e3e55f0` ON `groups_users`");
