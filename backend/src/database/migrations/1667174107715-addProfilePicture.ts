...
export class addProfilePicture1667174107715 implements MigrationInterface {
        ...
        if (dbType === "mysql") {
            await queryRunner.query(`
                CREATE TABLE profile_pictures (
                    ...
                    PRIMARY KEY (id),
                    UNIQUE KEY UQ_25de60ffee2a96a072c75d1f7a9 (file_name)
                )
            `);
            await queryRunner.query(`ALTER TABLE users ADD profile_picture_id int NULL`);
            await queryRunner.query(`ALTER TABLE users ADD CONSTRAINT UQ_02ec15de199e79a0c46869895f4 UNIQUE (profile_picture_id)`);
            await queryRunner.query(`ALTER TABLE users ADD CONSTRAINT FK_02ec15de199e79a0c46869895f4 FOREIGN KEY (profile_picture_id) REFERENCES profile_pictures(id) ON DELETE NO ACTION ON UPDATE NO ACTION`);
            return;
        }

        throw new Error(`Unsupported DB engine for migration addProfilePicture1667174107715: ${dbType}`);
    }
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        if (dbType === "mysql") {
            await queryRunner.query(`ALTER TABLE users DROP FOREIGN KEY FK_02ec15de199e79a0c46869895f4`);
            await queryRunner.query(`ALTER TABLE users DROP INDEX UQ_02ec15de199e79a0c46869895f4`);
            await queryRunner.query(`ALTER TABLE users DROP COLUMN profile_picture_id`);
            await queryRunner.query(`DROP TABLE IF EXISTS profile_pictures`);
            return;
        }
